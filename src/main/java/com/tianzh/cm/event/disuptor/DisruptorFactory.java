...
import com.tianzh.cm.domain.message.DomainEventDispatchHandler;
...
//        WaitStrategy waitStrategy2 = new YieldingWaitStrategy();

        ClaimStrategy claimStrategy = new MultiThreadedClaimStrategy(Integer.parseInt(RingBufferSize));
//        ClaimStrategy claimStrategy2 = new SingleThreadedClaimStrategy(Integer.parseInt(RingBufferSize));

        Disruptor disruptor = new Disruptor(this, Executors.newCachedThreadPool(new ThreadFactory() {
            @Override
